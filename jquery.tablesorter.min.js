    ...
    $.extend({
        tablesorter: new function() {
            ...
            function buildParserCache(table, $headers) {
                ...
                if (table.tBodies[0].rows[0]) {
                    ...
                    for (var i = 0; i < l; i++) {
                        ...
                        else if ($.metadata && ($($headers[i]).metadata() && $($headers[i]).metadata().sorter)) {
            ...
            function detectParserForColumn(table, node) {
                ...
                for (var i = 1; i < l; i++) {
                    if ($.trim(getElementText(table, node)) == 0) // ensure columns where the first row has a value equal to numeric 0 are read as digits not text
                    {
                        return parsers[i];
                    }
